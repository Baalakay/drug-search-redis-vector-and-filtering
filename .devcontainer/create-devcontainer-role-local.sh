...
# This version uses local file paths (for running on Mac/local machine)
...
if [ ! -f "devcontainer-iam-role-policy.json" ]; then
    echo "❌ Missing: devcontainer-iam-role-policy.json"
    echo "Please copy it with: scp ec2-devcontainer:/workspaces/DAW/.devcontainer/devcontainer-iam-role-policy.json ."
    exit 1
fi

if [ ! -f "devcontainer-permissions-policy.json" ]; then
    echo "❌ Missing: devcontainer-permissions-policy.json" 
    echo "Please copy it with: scp ec2-devcontainer:/workspaces/DAW/.devcontainer/devcontainer-permissions-policy.json ."
    exit 1
fi
