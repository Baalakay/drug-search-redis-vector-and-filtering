...
# ===================================================================
DEFAULT_LLM_MODEL = LLMModel.NOVA_MICRO  # Testing Amazon Nova Micro (cheapest, fastest)
# ===================================================================
...
def call_claude_converse(
    ...
    try:
        ...
        # Extract latency from ConverseMetrics (if available)
        ...
        return {
            ...
            'metadata': {
                ...
                'bedrock_latency_ms': bedrock_latency_ms,  # From Bedrock metrics
            },
